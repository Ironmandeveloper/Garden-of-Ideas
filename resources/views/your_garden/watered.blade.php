                                        ...
                                        <div class="ulp-flex-row ulp-flex-middle-xs ulp-flex-start-md">
                                            <div class="ulp-flex-col-xs-12">
                                                <div class="ulp-tabs top_side">
                                                    <div class="tab_nav">
                                                        <a href="{{ route('your.gardens') }}" class="nav_item nav_internal" target="_blank">Seeds
                                                            You've
                                                            Sown</a>
                                                        <a href="{{ route('chatify') }}" class="nav_item nav_internal"
                                                            target="_blank">Active Collaborations</a>
                                                        <a href="{{ route('your.garden.watered') }}" target="_blank" class="nav_item nav_internal active">Seeds You
                                                            Watered</a>
                                                    </div>
